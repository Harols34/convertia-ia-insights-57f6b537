-- Ocultar columnas en list_integration_table_columns según tenant_data_sources.restrictions.hidden_columns
-- super_admin y tenant_admin ven todas las columnas al configurar.
...
BEGIN
  ...
  WHERE n.nspname = 'public'
    ...
    AND (
      bypass_hidden
      OR NOT (a.attname = ANY (hidden_cols))
    )
  ORDER BY a.attnum;
END;
$$;
